...
#define IPMSG_VERSION   "1_QIPMSGV1.0"

#define IPMSG_DEFAULT_USERNAME "QIPMSGV.USER"
#define IPMSG_DEFAULT_NICKNAME  "QIPMSG.NICK"
#define IPMSG_DEFAULT_GROUPNAME "QIPMSG.GROUP"
